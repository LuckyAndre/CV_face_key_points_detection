...
# ПРОВЕРИЛ
# TODO Зачем дублировать трансформации??? Правильнее использовать segmentations/transforms/get_val_transforms
...
def get_boxes_from_mask(mask, margin, clip=False):
    ...
    # TODO посмотреть формат вывода этой функции
    boxes = []
...
# ПРОВЕРИЛ
# TODO Зачем дублировать трансформации??? Правильнее использовать recognition/transforms/get_val_transforms
