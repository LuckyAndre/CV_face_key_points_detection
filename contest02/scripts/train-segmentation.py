...
def validate(model, val_dataloader, device):
    ...
    val_dice = [] # TODO на валидации нужно смотреть на такую же метрику, как при обучении (иначе как оценить переобучение?)
...
def main(args):
    ...
    for arg, value in sorted(vars(args).items()): # vars returns the __dict__ attribute of the given object
